<script lang="ts">
  ...
  import { listInventory, type InventoryRow } from "$lib/inventory/inventory";
  import { layerDisplayName } from "$lib/detail/layerName";
  import { splitProvenance } from "$lib/detail/provenance";
  import { nav, openInSection } from "$lib/shell/nav.svelte";
  ...
  import SkinDetail from "$lib/components/detail/SkinDetail.svelte";
