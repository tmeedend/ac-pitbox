...
pub const UNMANAGED_NOT_ACTIVATABLE: &str = "errors.unmanagedNotActivatable";
pub const UNMANAGED_NO_LAYER: &str = "errors.unmanagedNoLayer";
...
/// Un `.kn5` déposé seul, qui n'est pas un mannequin de pilote : rien ne dit
