...
| **Garder dans les ressources du mod** | rangé sous son propre nom dans les ressources du propriétaire, consultable depuis sa fiche. Rien n'entre dans le jeu. Le libellé nomme l'endroit où le dossier réapparaîtra — « garder sans installer » disait ce que l'action ne fait pas, pas où elle range. Il nomme les *ressources*, pas un onglet : sur la fiche d'une voiture ou d'un circuit, c'est une carte de l'onglet « Médias et documents », sur celle d'un pack ou d'une app un onglet à part, et « l'onglet Ressources » envoyait chercher un onglet qui n'existait plus. | rien à défaire |
